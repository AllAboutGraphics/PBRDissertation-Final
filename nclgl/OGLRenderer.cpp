...
void OGLRenderer::SetTextureRepeating(GLuint target, bool isRepeating)
{
...
void OGLRenderer::SetTextureFiltering(GLuint target, bool isBiLinear)
{
	glBindTexture(GL_TEXTURE_2D, target);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, isBiLinear ? GL_LINEAR : GL_NEAREST);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, isBiLinear ? GL_LINEAR : GL_NEAREST);
	glBindTexture(GL_TEXTURE_2D, 0);
}
